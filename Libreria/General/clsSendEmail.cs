...
namespace Libreria.General
{
    public static class clsSendEmail
    {
        ...
        private static void SendCompletedCallback(object sender, AsyncCompletedEventArgs e)
        {
            ...
            MetodoRespuesta ent = new MetodoRespuesta();
        ...
        public static Boolean SendEmailAsync(string mailTo, string message, string subject, string mailFrom_pseudo = "")//ok
        {
            try
            {
                MetodoRespuesta Base = new MetodoRespuesta();
        ...
        public static bool SendEmail(ref MetodoRespuesta Base, List<string> mailTo, List<string> mailCc, List<string> mailCo, string message, string subject, string mailFrom)
        {
            try
            {
                string mailServer = "smtp.fatcow.com";
        ...
        public static bool SendEmailAsync(ref MetodoRespuesta Base, List<string> mailTo, List<string> mailCc, List<string> mailCo, string message, string subject, string mailfrom)
        {
            try
            {
        ...
        public static bool SendEmail(ref MetodoRespuesta Base, List<String> mailTo, string message, string subject,string mailFrom)
        {
            try
            {
                //If LoadConfiguration("EMAIL_DISABLED") = "1" Then Exit Function
        ...
        private static clsEmailServer GetEmailServer(ref MetodoRespuesta Base)
        {
        ...
        private static clsEmailServerRecognition GetEmailServer_Recognition(ref MetodoRespuesta Base)
        {
