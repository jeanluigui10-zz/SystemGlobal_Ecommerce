...
namespace xAPI.Dao.Cotizations
{
    public class CotizationDAO
    {
        #region Singleton

        private static CotizationDAO instance = null;
        public static CotizationDAO Instance
        {
            get
            {
                if (instance == null)
                    instance = new CotizationDAO();
                return instance;
            }
        }
        ...
        private Cotization GetEntity_v3(SqlDataReader ObjDr)
        {
            Cotization obj = new Cotization
            {
        ...
        public Cotization GetAllByID(ref BaseEntity Base, Int32 ID)
        {
            ...
            {
                objAppResource = null;
                Base.Errors.Add(new BaseEntity.ListError(ex, "An error occurred  getting a Cotization by it's Id."));
            }
            finally
            {
        ...
        public Boolean Save(ref BaseEntity Entity, /*tBaseLanguagueIdList listLanguages,*/ Cotization Resource, Boolean RegisterTBL = false, String UserName = "")
        {
            Boolean success = false;
            SqlCommand cmd = null;
            try
            {
                cmd = new SqlCommand("Cotization_SaveFile_Sp", clsConnection.GetConnection())
                {
                    CommandType = CommandType.StoredProcedure
                };
                ...
                cmd.Parameters.AddWithValue("@COMPANY", Resource.Company);
                cmd.Parameters.AddWithValue("@PHONE", Resource.Phone);                 
        ...
        public Boolean SaveMyPhoto(ref BaseEntity Entity, Cotization Resource)
        {
            Boolean success = false;
            SqlCommand cmd = null;
            try
        ...
        public Int32 Get_QuantityLegalDocuments(ref BaseEntity Entity, Cotization resource/*, tBaseLanguagueIdList ListLanguage*/)
        {
            Int32 quantity = -1;
            SqlCommand cmd = null;
            try
