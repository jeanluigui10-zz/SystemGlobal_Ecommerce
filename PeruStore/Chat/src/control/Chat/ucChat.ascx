<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucChat.ascx.cs" Inherits="PeruStore.Chat.src.control.Chat.ucChat" %>
...
<%--        $.connection.hub.url = "<%=PeruStore.Chat.src.app_code.xConfig.url_apichat + "signalr/"%>";--%>
