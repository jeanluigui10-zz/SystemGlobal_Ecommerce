...
<li><a href="">&gt;|</a></li>
    ...
    <script type="text/x-handlebars-template" id="handlebards-listaProductoxCategoria">
     ...
     <script type="text/x-handlebars-template" id="handlebards-listaCategorias">
        {{# each request}}
         <li class="hadchild"><a id="Cate_{{IdCategoria}}" onclick="Fn_ListarProductosPorCategoria('{{IdCategoriaCifrado}}', '{{CategoriaNombre}}', '{{IdCategoria}}')">{{CategoriaNombre}}</a>   <span class="button-view  fa fa-plus-square-o"></span>
