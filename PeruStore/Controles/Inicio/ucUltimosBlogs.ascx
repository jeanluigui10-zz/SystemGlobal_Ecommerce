<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucUltimosBlogs.ascx.cs" Inherits="PeruStore.Controles.Inicio.ucUltimosBlogs" %>
<div class="module so-latest-blog blog-home blog-home2">
    <h3 class="modtitle"><span>Nuestros Últimos Blogs</span></h3>
                        ...
                        <div class="media-body">
                            <div class="media-content">
                                ...
                                <div class="media-date-added idx-other">
                                    <i class="fa fa-calendar"></i><span class="media-date-added">November 15th, 2017</span>
                                </div>
