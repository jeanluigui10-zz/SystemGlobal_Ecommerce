					...
					<div class="tt-product-vertical-layout">
						...
						<div class="tt-product-single-carousel-vertical">
							<ul id="smallGallery" class="tt-slick-button-vertical  slick-animated-show-js">
								<li><a class="zoomGalleryActive" href="#" data-image="../Files/images/product/product-01.jpg" data-zoom-image="../Files/images/product/product-01.jpg"><img src="../Files/images/product/product-01.jpg" alt=""></a></li>
								<li><a href="#" data-image="../Files/images/product/product-01-02.jpg" data-zoom-image="../Files/images/product/product-01-02.jpg"><img src="../Files/images/product/product-01-02.jpg" alt=""></a></li>
								<li><a href="#" data-image="../Files/images/product/product-01-03.jpg" data-zoom-image="../Files/images/product/product-01-03.jpg"><img src="../Files/images/product/product-01-03.jpg" alt=""></a></li>
								<li><a href="#" data-image="../Files/images/product/product-01-04.jpg" data-zoom-image="../Files/images/product/product-01-04.jpg"><img src="../Files/images/product/product-01-04.jpg" alt=""></a></li>
								<li>
					...
					<div class="tt-product-single-info">
						...
						<div class="tt-wrapper">
							<div class="tt-row-custom-01">
								...
								<div class="col-item">
									<a href="#" class="btn btn-lg"><i class="icon-f-39" style="top:3px"></i>Agregar Producto</a>
								</div>
							</div>
						</div>
						<div class="tt-wrapper">
								...
								<div class="tt-collapse-content">
									<div class="tt-review-block">
										...
										<div class="tt-review-comments">
											<div class="tt-item">
												<div class="tt-avatar">
													<a href="#"><img src="../Files/images/product/single/review-comments-img-01.jpg" alt=""></a>
												</div>
											...
											<div class="tt-item">
												<div class="tt-avatar">
													<a href="#"><img src="../Files/images/product/single/review-comments-img-02.jpg" alt=""></a>
												</div>
												<div class="tt-content">
													<div class="tt-rating">
														<i class="icon-star"></i>
				...
				<div class="col-2 col-md-4 col-lg-3">
					<div class="tt-product thumbprod-center">
						<div class="tt-image-box">
							...
							<a href="product.html">
								<span class="tt-img"><img src="../Files/images/product/product-16.jpg" alt=""></span>
								<span class="tt-img-roll-over"><img src="../Files/images/product/product-16-02.jpg" alt=""></span>
							</a>
						</div>
						<div class="tt-description">
							...
							<div class="tt-product-inside-hover">
								<div class="tt-row-btn">
									<a href="#" class="tt-btn-addtocart thumbprod-button-bg add-to-cart-mp" data-productid="{{Id}}" data-productname="{{Name}}" data-srcimg="{{NameResource}}" data-unitprice="{{UnitPrice}}" style="cursor:pointer">Agregar Producto</a>
								</div>
								<div class="tt-row-btn">
				...
				<div class="col-2 col-md-4 col-lg-3">
					<div class="tt-product thumbprod-center">
						<div class="tt-image-box">
							...
							<a href="#" class="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></a>
							<a href="product.html">
								<span class="tt-img"><img src="../Files/images/product/product-18.jpg" alt=""></span>
								<span class="tt-img-roll-over"><img src="../Files/images/product/product-18-02.jpg" alt=""></span>
							</a>
						</div>
						<div class="tt-description">
							<div class="tt-row">
				...
				<div class="col-2 col-md-4 col-lg-3">
					<div class="tt-product thumbprod-center">
						<div class="tt-image-box">
							...
							<a href="#" class="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></a>
							<a href="product.html">
								<span class="tt-img"><img src="../Files/images/product/product-19.jpg" alt=""></span>
								<span class="tt-img-roll-over"><img src="../Files/images/product/product-19-02.jpg" alt=""></span>
							</a>
						</div>
						<div class="tt-description">
							<div class="tt-row">
				...
				<div class="col-2 col-md-4 col-lg-3">
					<div class="tt-product thumbprod-center">
						<div class="tt-image-box">
							...
							<a href="#" class="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></a>
							<a href="product.html">
								<span class="tt-img"><img src="../Files/images/product/product-14.jpg" alt=""></span>
								<span class="tt-img-roll-over"><img src="../Files/images/product/product-14-02.jpg" alt=""></span>
							</a>
						</div>
						<div class="tt-description">
							<div class="tt-row">
					...
					<div class="row">
						<div class="col-12 col-lg-6">
							...
							<div class="tt-modal-product">
								<div class="tt-img">
									<img src="images/loader.svg" data-src="../Files/images/product/product-01.jpg" alt="">
								</div>
								<h2 class="tt-title"><a href="product.html">Flared Shift Dress</a></h2>
								<div class="tt-qty">
									QTY: <span>1</span>
							...
							<div class="tt-product-single-info">
								...
								<div class="tt-wrapper">
									<div class="tt-row-custom-01">
										...
										<div class="col-item">
											<a href="#" class="btn btn-lg"><i class="icon-f-39"></i>Agregar Producto</a>
										</div>
									</div>
								</div>
							</div>
