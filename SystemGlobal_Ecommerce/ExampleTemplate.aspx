<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExampleTemplate.aspx.cs" Inherits="SystemGlobal_Ecommerce.ExampleTemplate" %>
...
<head runat="server">
    ...
    <!-- Favicon
    ============================================ -->
    <link rel="shortcut icon" type="image/png" href="Template/ico/favicon-16x16.png"/>
    ...
    <link href="Template/js/datetimepicker/bootstrap-datetimepicker.min.css" rel="stylesheet">
    <link href="Template/js/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="Template/css/themecss/lib.css" rel="stylesheet">
    ...
    <!-- Theme CSS
    ============================================ -->
    <link href="Template/css/themecss/so_searchpro.css" rel="stylesheet">
    <link href="Template/css/themecss/so_megamenu.css" rel="stylesheet">
    <link href="Template/css/themecss/so-categories.css" rel="stylesheet">
    <link href="Template/css/themecss/so-listing-tabs.css" rel="stylesheet">
    <link href="Template/css/themecss/so-newletter-popup.css" rel="stylesheet">

    <link href="Template/css/footer/footer1.css" rel="stylesheet">
    <link href="Template/css/header/header1.css" rel="stylesheet">
    <link id="color_scheme" href="Template/css/theme.css" rel="stylesheet"> 
                            ...
                            <li class="language">
                                <div class="btn-group languages-block ">
                                    <form action="index.html" method="post" enctype="multipart/form-data" id="bt-language">
                                        <a class="btn btn-link dropdown-toggle" data-toggle="dropdown">
                                            <img src="Template/image/catalog/flags/gb.png" alt="English" title="English">
                                            <span class="">English</span>
                                            <span class="fa fa-angle-down"></span>
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li><a href="index.html"><img class="image_flag" src="Template/image/catalog/flags/gb.png" alt="English" title="English" /> English </a></li>
                                            <li> <a href="index.html"> <img class="image_flag" src="Template/image/catalog/flags/ar.png" alt="Arabic" title="Arabic" /> Arabic </a> </li>
                                        </ul>
                                    </form>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="navbar-logo col-lg-2 col-md-2 col-sm-12 col-xs-12">
                        <div class="logo"><a href="index.html"><img src="Template/image/catalog/logo.png" title="Your Store" alt="Your Store" /></a></div>
                    </div>
                    <!-- //end Logo -->
                                                ...
                                                <ul class="megamenu" data-transition="slide" data-animationtime="250">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <a href="index.html" class="image-link"> 
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border" src="Template/image/catalog/menu/home-1.jpg" alt="">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home2.html" class="image-link"> 
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border" src="Template/image/catalog/menu/home-2.jpg" alt="">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home3.html" class="image-link"> 
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border" src="Template/image/catalog/menu/home-3.jpg" alt="">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home4.html" class="image-link"> 
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border" src="Template/image/catalog/menu/home-4.jpg" alt="">
                                                                    ...
                                                                    <!-- <div class="col-md-15">
                                                                        <a href="#" class="image-link"> 
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border" src="Template/image/demo/feature/comming-soon.png" alt="">
                                                    ...
                                                    <li class="with-sub-menu hover">
                                                        ...
                                                        <a href="#" class="clearfix">
                                                            ...
                                                            <img class="label-hot" src="Template/image/catalog/menu/new-icon.png" alt="icon items">
                                                            <b class="caret"></b>
                                                        </a>
                                                    ...
                                                    <li class="with-sub-menu hover">
                                                        ...
                                                        <a href="#" class="clearfix">
                                                            ...
                                                            <img class="label-hot" src="Template/image/catalog/menu/hot-icon.png" alt="icon items">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="row">
                                                                            <div class="col-md-3 img img1">
                                                                                <a href="#"><img src="Template/image/catalog/menu/megabanner/image-1.jpg" alt="banner1"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img2">
                                                                                <a href="#"><img src="Template/image/catalog/menu/megabanner/image-2.jpg" alt="banner2"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img3">
                                                                                <a href="#"><img src="Template/image/catalog/menu/megabanner/image-3.jpg" alt="banner3"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img4">
                                                                                <a href="#"><img src="Template/image/catalog/menu/megabanner/image-4.jpg" alt="banner4"></a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="container-mega">
                                                    <ul class="megamenu">
                                                        <li class="item-vertical  with-sub-menu hover">
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="Template/image/catalog/menu/icons/ico10.png" alt="icon">
                                                        ...
                                                        <li class="item-vertical">
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="Template/image/catalog/menu/icons/ico1.png" alt="icon">
                                                        ...
                                                        <li class="item-vertical  style1 with-sub-menu hover">
                                                            ...
                                                            <a href="#" class="clearfix">
                                                                <span class="label"></span>
                                                                <img src="Template/image/catalog/menu/icons/ico9.png" alt="icon">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="row banner">
                                                                                <a href="#">
                                                                                    <img src="Template/image/catalog/menu/megabanner/vbanner1.jpg" alt="banner1">
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <li class="item-vertical with-sub-menu hover">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="Template/image/catalog/menu/icons/ico7.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical css-menu with-sub-menu hover">
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                     ...
                                                                     <img src="Template/image/catalog/menu/icons/ico6.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="Template/image/catalog/menu/icons/ico5.png" alt="icon">
                                                                    <span>Health & Beauty</span>
                                                            ...
                                                            <li class="item-vertical">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="Template/image/catalog/menu/icons/ico4.png" alt="icon">
                                                                    <span>Bathroom</span>
                                                                </a>
                                                            </li>
                                                            <li class="item-vertical">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="Template/image/catalog/menu/icons/ico3.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical" >
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                    <img src="Template/image/catalog/menu/icons/ico2.png" alt="icon">
                                                                    <span>Bedroom</span>
                                                                </a>
                                                            </li>
                                                            <li class="item-vertical" >
                                                            ...
                                                            <li class="item-vertical" style="display: none;">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="Template/image/catalog/menu/icons/ico11.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical" style="display: none;">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="Template/image/catalog/menu/icons/ico12.png" alt="icon">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="text-center" style="width:70px">
                                                        <a href="product.html">
                                                            <img src="Template/image/catalog/demo/product/80/1.jpg" style="width:70px" alt="Yutculpa ullamcon" title="Yutculpa ullamco" class="preview">
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="text-center" style="width:70px">
                                                        <a href="product.html">
                                                            <img src="Template/image/catalog/demo/product/80/2.jpg" style="width:70px" alt="Xancetta bresao" title="Xancetta bresao" class="preview">
                                                        </a>
                                                    </td>
            ...
            <div class="module sohomepage-slider ">
                <div class="yt-content-slider"  data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column0="1" data-items_column1="1" data-items_column2="1"  data-items_column3="1" data-items_column4="1" data-arrows="no" data-pagination="yes" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
                    <div class="yt-content-slide">
                        <a href="#"><img src="Template/image/catalog/slideshow/home1/slider-1.jpg" alt="slider1" class="img-responsive"></a>
                    </div>
                    <div class="yt-content-slide">
                        <a href="#"><img src="Template/image/catalog/slideshow/home1/slider-2.jpg" alt="slider2" class="img-responsive"></a>
                    </div>
                    <div class="yt-content-slide">
                        <a href="#"><img src="Template/image/catalog/slideshow/home1/slider-3.jpg" alt="slider3" class="img-responsive"></a>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 main-left sidebar-offcanvas">
                ...
                <div class="module">
                    <div class="banners banners2">
                        <div class="banner">
                            <a href="#"><img src="Template/image/catalog/banners/banner4.jpg" alt="image"></a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Mandouille short ">
                                                    <img src="Template/image/catalog/demo/product/80/1.jpg" alt="Mandouille short">
                                                    </a>
                                            </div>
                                        ...
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Xancetta bresao ">
                                                        <img src="Template/image/catalog/demo/product/80/2.jpg" alt="Xancetta bresao">
                                                        </a>
                                            </div>
                                        ...
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Sausage cowbee ">
                                                            <img src="Template/image/catalog/demo/product/80/3.jpg" alt="Sausage cowbee">
                                                            </a>
                                            </div>
                                        ...
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Chicken swinesha ">
                                                                <img src="Template/image/catalog/demo/product/80/4.jpg" alt="Chicken swinesha">
                                                                </a>
                                            </div>
                                ...
                                <div class="item ">
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                ...
                                                <img src="Template/image/catalog/demo/product/80/5.jpg" alt="Qeserunt shortloin">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                ...
                                                <img src="Template/image/catalog/demo/product/80/6.jpg" alt="Consecte quichuck">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            ...
                                            <img src="Template/image/catalog/demo/product/80/7.jpg" alt="Neatball bresaola">
                                            </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                ...
                                                <img src="Template/image/catalog/demo/product/80/8.jpg" alt="Yutculpa ullamco">
                                                </a>
                                            </div>
                ...
                <div class="module">
                    <div class="banners banners4">
                        <div class="banner">
                            <a href="#"><img src="Template/image/catalog/banners/banner5.jpg" alt="image"></a>
                        </div>
                    </div>
                </div>
                            ...
                            data-pagination="yes" data-lazyload="yes" data-loop="yes" data-buttonpage="top">
                                <div class="media" > 
                                    <div class="item head-button">
                                            <div class="media-left so-block">
                                                <a href="#" target="_self">
                                                    <img src="Template/image/catalog/blog/2.jpg" alt="Duis autem vel eum irure sed diam nonumy">
                                                </a>
                                            </div>
                                ...
                                <div class="media" > 
                                    <div class="item head-button">
                                            <div class="media-left so-block">
                                                <a href="#" target="_self">
                                                    <img src="Template/image/catalog/blog/4.jpg" alt="Duis autem vel eum irure sed diam nonumy">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <div class="media-content so-block">
                                ...
                                <div class="media" > 
                                    <div class="item head-button">
                                            <div class="media-left so-block">
                                                <a href="#" target="_self">
                                                    <img src="Template/image/catalog/blog/1.jpg" alt="Duis autem vel eum irure sed diam nonumy">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <div class="media-content so-block">
                                ...
                                <div class="item ">
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Mandouille short ">
                                                    <img src="Template/image/catalog/demo/product/80/8.jpg" alt="Mandouille short">
                                                    </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Xancetta bresao ">
                                                        <img src="Template/image/catalog/demo/product/80/7.jpg" alt="Xancetta bresao">
                                                        </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Sausage cowbee ">
                                                            <img src="Template/image/catalog/demo/product/80/6.jpg" alt="Sausage cowbee">
                                                            </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Chicken swinesha ">
                                                <img src="Template/image/catalog/demo/product/80/5.jpg" alt="Chicken swinesha">
                                                </a>
                                            </div>
                                ...
                                <div class="item ">
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Qeserunt shortloin ">
                                                <img src="Template/image/catalog/demo/product/80/4.jpg" alt="Qeserunt shortloin">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Consecte quichuck ">
                                                <img src="Template/image/catalog/demo/product/80/3.jpg" alt="Consecte quichuck">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Neatball bresaola ">
                                            <img src="Template/image/catalog/demo/product/80/2.jpg" alt="Neatball bresaola">
                                            </a>
                                            </div>
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="#" target="_self" title="Yutculpa ullamco ">
                                                <img src="Template/image/catalog/demo/product/80/1.jpg" alt="Yutculpa ullamco">
                                                </a>
                                            </div>
                ...
                <div class="module">
                    <div class="banners banners5">
                        <div class="banner">
                            <a href="#"><img src="Template/image/catalog/banners/banner6.jpg" alt="image"></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 main-right">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 col3">
                        <div class="modcontent clearfix">
                            <div class="banners banners1"> 
                                <div class="b-img">
                                        <a href="#"><img src="Template/image/catalog/banners/banner1.jpg" alt="banner1"></a>
                                </div>
                                <div class="b-img2">
                                        <a href="#"><img src="Template/image/catalog/banners/banner2.jpg" alt="banner2"></a>
                                </div>    
                ...
                <div class="banners banners3">
                    <div class="banner">
                        <a href="#">
                            <img src="Template/image/catalog/banners/banner3.jpg" alt="image">
                        </a>
                    </div>
                </div>
                                                ...
                                                <div class="item-left col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                    <div class="image"> 
                                                        ...
                                                        <a href="#" target="_self" title="product">
                                                            <img src="Template/image/catalog/demo/product/320/1.jpg" alt="Yutculpa ullamco" class="img-responsive">
                                                        </a>
                                            ...
                                            <div class="inner">
                                                <div class="item-left col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                    <div class="image"> 
                                                        ...
                                                        <a href="#" target="_self" title="Xancetta bresao">
                                                            <img src="Template/image/catalog/demo/product/320/2.jpg" alt="Xancetta bresao" class="img-responsive">
                                                        </a>
                                                        <div class="button-group so-quickview">
                                                ...
                                                <div class="item-left col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                    <div class="image">
                                                        ...
                                                        <a href="#" target="_self" title="Wamboudin ribeye">
                                                            <img src="Template/image/catalog/demo/product/320/3.jpg" alt="Wamboudin ribeye" class="img-responsive">
                                                        </a>
                                                        <div class="button-group so-quickview">
                                                ...
                                                <div class="item-left col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                    <div class="image">
                                                        ...
                                                        <a href="#" target="_self" title="Proident leerkas">
                                                            <img src="Template/image/catalog/demo/product/320/4.jpg" alt="Proident leerkas" class="img-responsive">
                                                        </a>
                                                        <div class="button-group so-quickview">
                ...
                <div class="banners banners6">
                    <div class="banner">
                        <a href="#">
                            <img src="Template/image/catalog/banners/banner7.jpg" alt="image">
                        </a>
                    </div>
                </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Pastrami bacon">
                                                                <img src="Template/image/catalog/demo/product/270/1.jpg" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="Template/image/catalog/demo/product/270/12.jpg" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Chicken swinesha">
                                                                <img src="Template/image/catalog/demo/product/270/2.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/11.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                                <img src="Template/image/catalog/demo/product/270/3.jpg" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="Template/image/catalog/demo/product/270/10.jpg" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Sausage cowbee">
                                                                <img src="Template/image/catalog/demo/product/270/4.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/9.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                                <img src="Template/image/catalog/demo/product/270/5.jpg" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="Template/image/catalog/demo/product/270/8.jpg" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Balltip nullaelit">
                                                                <img src="Template/image/catalog/demo/product/270/6.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/7.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-new"> New </span></div>
                                                        <div class="button-group so-quickview cartinfo--left">
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Ribeye hamhock">
                                                                <img src="Template/image/catalog/demo/product/270/7.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/6.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Wamboudin ribeye">
                                                                <img src="Template/image/catalog/demo/product/270/8.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/5.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Lamboudin ribeye">
                                                                <img src="Template/image/catalog/demo/product/270/9.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/4.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Ribeye hamhock">
                                                                <img src="Template/image/catalog/demo/product/270/10.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/3.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-sale"> -7% </span></div>
                                                        <div class="button-group so-quickview cartinfo--left">
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                                <img src="Template/image/catalog/demo/product/270/11.jpg" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="Template/image/catalog/demo/product/270/2.jpg" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Balltip nullaelit">
                                                                <img src="Template/image/catalog/demo/product/270/12.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/1.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-new"> New </span></div>
                                                        <div class="button-group so-quickview cartinfo--left">
                ...
                <div class="banners banners7">
                    <div class="row">
                        <div class="banner1 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="b1">
                                <a href="#">
                                    <img src="Template/image/catalog/banners/banner8.jpg" alt="image">
                                </a>
                            </div>
                            <div class="b2">
                                <a href="#">
                                    <img src="Template/image/catalog/banners/banner9.jpg" alt="image">
                                </a>
                            </div>
                        </div>
                        <div class="banner2 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <a href="#">
                                <img src="Template/image/catalog/banners/banner10.jpg" alt="image">
                            </a>
                        </div>
                        <div class="banner3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="b1">
                                <a href="#">
                                    <img src="Template/image/catalog/banners/banner11.jpg" alt="image">
                                </a>
                            </div>
                            <div class="b2">
                                <a href="#">
                                    <img src="Template/image/catalog/banners/banner12.jpg" alt="image">
                                </a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid first-item">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Pastrami bacon">
                                                                <img src="Template/image/catalog/demo/product/funiture/10.jpg" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="Template/image/catalog/demo/product/funiture/9.jpg" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Chicken swinesha">
                                                                <img src="Template/image/catalog/demo/product/270/15.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/2.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-sale"> -16% </span></div>
                                                        <div class="button-group so-quickview cartinfo--left">
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                                <img src="Template/image/catalog/demo/product/270/14.jpg" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="Template/image/catalog/demo/product/270/3.jpg" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-new"> New </span></div>
                                                        <div class="button-group so-quickview cartinfo--left">
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Sausage cowbee">
                                                                <img src="Template/image/catalog/demo/product/270/13.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/4.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                                <img src="Template/image/catalog/demo/product/270/12.jpg" class="img-1 img-responsive" alt="Pastrami bacon">
                                                                <img src="Template/image/catalog/demo/product/270/5.jpg" class="img-2 img-responsive" alt="Pastrami bacon">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="item-inner product-layout transition product-grid">
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="product.html" target="_self" title="Balltip nullaelit">
                                                                <img src="Template/image/catalog/demo/product/270/11.jpg" class="img-1 img-responsive" alt="image">
                                                                <img src="Template/image/catalog/demo/product/270/6.jpg" class="img-2 img-responsive" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="box-label"> <span class="label-product label-new"> New </span></div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 col-style">
                        <div class="infos-footer">
                            <a href="#"><img src="Template/image/catalog/logo-footer.png" alt="image"></a>
                            <ul class="menu">
                                <li class="adres">
                    ...
                    <div class="col-lg-12 col-xs-12 text-center">
                        <img src="Template/image/catalog/demo/payment/payment.png" alt="imgpayment">
                    </div>
                </div>
            </div>
        </div>
